...
public class BMRoom : IBMRoom
{

	private Dictionary<string,BMRoomVariable> variableTable = new Dictionary<string,BMRoomVariable> ();
	private int id;
	private string name;

	public BMRoom (int id, string name)
	{
		this.id = id;
		this.name = name;
	}
	...
	/// <param name="variableName">Variable name.</param>
	public BMRoomVariable GetVariable (string variableName)
	{
	...
	public bool SetVariable (string variableName, BMRoomVariable variable)
	{
		try {
	...
	public Dictionary<string,BMRoomVariable> GetVariables ()
	{
